...
<div id="content">
    ...
    <script>
        Highcharts.chart('containerchart', {
            ...
            tooltip: {
                pointFormat: '<b>{point.y:.1f} Pack</b>'
            },
            series: [{
                name: 'Population',
                data: [
